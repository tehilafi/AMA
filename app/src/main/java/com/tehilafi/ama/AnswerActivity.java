...
public class AnswerActivity extends Activity {
    ...
    private ImageView  add_pic, add_video, checkVID, checkPID, with_ans, starID;
    private int score, numAns, numPIc, stars, num_ans, num_question, numComments;
    ...
    private String imageFileName , imageFileName1, from = "empty", location, id_asking;
    private SharedPreferences mPreferences;
    private AlertDialog.Builder builder;
    private byte bb[];
    ArrayList<String> do_like = new ArrayList<String>();
...
// *******************************  Get the token of device asking and details from Users DB  *******************************
        ...
        myQueryUser.addChildEventListener( new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                if (id_asking.equals(String.valueOf(snapshot.getValue( Users.class ).getId())))
                    askingToken.add( "token,"+snapshot.getValue( Users.class ).getId());
        ...
        btnSave.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (checkContent) {
                    ...
                    if(from3) {
                        if(uploadImageFromCamera(getApplicationContext(), bb, String.valueOf(num_ans + 1), "null", "pic") == true) {
                            reffUser.child( mPreferences.getString( getString( R.string.id ), "" ) ).child( "numPicture" ).setValue( numPIc + 1 );
                    ...
                    sendNotification( askingToken, "תשובה חדשה",  edtContent.getText().toString().trim(), "answer", "MyQuestionActivity");
