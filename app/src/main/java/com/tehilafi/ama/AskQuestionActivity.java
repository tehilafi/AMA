...
//************************************* Get the score from Users DB  *************************************
                    ...
                    storageReff.child("profile picture/").child( String.valueOf( idUser ) ).getDownloadUrl().addOnSuccessListener( new OnSuccessListener<Uri>()
                    {
                        ...
                        public void onSuccess(Uri downloadUrl)
                        {
                            ...
                            if(numComments >= 1)
                                arrayList.add( new ListView_item( downloadUrl.toString(), nameUser, dateTime, String.valueOf(numQuestion),  text, R.drawable.with_answer, starR[0]) );
                            else
                                arrayList.add( new ListView_item( downloadUrl.toString(), nameUser, dateTime, String.valueOf(numQuestion), text, R.drawable.transillumination, starR[0]));
