...
public class OneAnswerActivity extends Activity {
    ...
    private String num_answer, id_answer, numL = "NUll";
    public static final String TAG = "MyTag";
    DatabaseReference reff, reffUser;
    ImageView imageView, starID, likeID;
    VideoView videoView;
...
// *******************************  OnClick  *******************************
        ...
        likeID.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(android.view.View view) {
                ...
                if (!do_like.contains( String.valueOf(mPreferences.getString( getString( R.string.id ), "" )))) {
                    do_like.add( mPreferences.getString( getString( R.string.id ), "" ) );
                    reff.child( "do_like" ).setValue( do_like );
