...
public class MyBackgroundService extends Service {
 ...
 private static final String EXTRA_STARTED_FROM_NOTIFICATION ="com.tehilafi.ama"+".started_from_notification" ;
 private final IBinder mBinder=new LocalBinder();
    ...
    public void onCreate()
    {
       ...
       getLastLocation();
        ...
        //SET THE CHANEL ID FOR THE ANDROID O
    ...
    private void onNewLocation(Location lastLocation)
    {
        ...
        if(serviceIsRunningInForeGround(this))
         mNotificationManager.notify(NOTI_ID,getNotificiation());
    }

    private Notification getNotificiation() {
     Intent intent=new Intent(this,MyBackgroundService.class);
     String text =Common.GetLocayionText(mLocation);
     ...
     NotificationCompat.Builder builder=new NotificationCompat.Builder(this)
             ...
             .setContentText(text)
             .setContentTitle(Common.GetLocayionTitle(this))
             .setOngoing(true)
 ...
 private boolean serviceIsRunningInForeGround(Context context) {
    ...
    public boolean onUnbind(Intent intent) {
        if(!mChangingConfiguration&&Common.requestingLocationUpdates(this))
            startForeground(NOTI_ID,getNotificiation());
        return true;
    }
