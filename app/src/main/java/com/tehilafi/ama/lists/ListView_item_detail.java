...
public class ListView_item_detail {
    ...
    public ListView_item_detail(String image,  String userName, String date, String numA, String content, String numLike, int add_videoID,  int add_picID, int starID, int likeID){
        Image = image;
        UserName = userName;
        Date = date;
        NumA = numA;
